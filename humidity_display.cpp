...
// CCIIIIII           B        HHHHHHH  TTTTTTT  TTTTTTT
// 11001100 01001000 01000100 00110110 00001001 00110011 11001010
//                             0110110                                     54
//                                         1001  0110011                   19
...
void loop() {
  if (received == true) {
	...
	stopIndex = (syncIndex1 + (0*8+2)*2) % RING_BUFFER_SIZE;
...
//    unsigned int startIndex, stopIndex;
    ...
    fail = false;
    startIndex = (syncIndex1 + (2*8+1)*2) % RING_BUFFER_SIZE;
    stopIndex =  (syncIndex1 + (2*8+2)*2) % RING_BUFFER_SIZE;
